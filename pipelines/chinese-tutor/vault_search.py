...
def main():
    ...
    parser.add_argument("--path", default="/home/alex/Ai-chinese/data/vaults/chinese-tutor", help="Ruta al directorio de notas (default: /home/alex/Ai-chinese/data/vaults/chinese-tutor)")
