...
# The actual Obsidian vault is in the parent directory of 'generator'
vault_dir = os.path.abspath(os.path.join(os.path.dirname(base_dir), "vault", "nemotecnia"))
...
# Mount parent directory for HTML webapps (Mo-Reader, Mo-Cards, etc.)
project_root_dir = os.path.dirname(os.path.dirname(base_dir))
app.mount("/app", StaticFiles(directory=project_root_dir), name="project_root")
...
# Serve the parent project directory (/home/alex/Ai-chinese/) at the root level /
# This matches files like /Mo-Dict.html, /mo-common.js, /mo-layout.css, etc.
app.mount("/", StaticFiles(directory=project_root_dir, html=True), name="project_root_at_root")
